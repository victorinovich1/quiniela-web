    ...
    <div className="-mx-4 sm:-mx-6 lg:-mx-8 -my-6 bg-navy-deepest">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { 
                ...
                img: '/images/landing/paso1.webp' 
              },
              { 
                num: 2, 
                title: 'Crea tu quiniela', 
                desc: 'Dale un nombre creativo', 
                img: '/images/landing/paso2.webp' 
              },
              { 
                num: 3, 
                title: 'Pronostica', 
                desc: 'Llena todos los marcadores', 
                img: '/images/landing/paso3.webp' 
              },
              { 
                num: 4, 
                title: 'Compite', 
                desc: 'Sube en el ranking en vivo', 
                img: '/images/landing/paso4.webp' 
              },
            ].map((paso) => (
              <div 
                key={paso.num}
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative aspect-square rounded-2xl overflow-hidden">
              <div 
                ...
                style={{ backgroundImage: 'url(/images/landing/estadio.webp)' }}
              />
      ...
      <footer className="py-16 px-4 border-t border-white/10">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-6">
            <img 
              src="/images/landing/trofeo.webp" 
